...
class QuestionController extends Controller
{
    ...
    public function store(Request $request)
    {
        try
        {
            ...
            else
            {
                ...
                {
                $image_file = $request->question_image;
    ...
    {
     $image = Question::findOrFail($image_id);

     $question_image = Image::make($image->question_image);

     $response = Response::make($question_image->encode('jpeg'));
